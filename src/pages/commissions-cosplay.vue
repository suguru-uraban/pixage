<template>
  <div class="commissions">
    <Loading v-if="processingCommissionCosplay" page-type="normal" />
    <section class="commissions__list">
      <h1 class="commissions__listTitle">{{ $t('commissionCosplayList.title') }}</h1>
      <CommissionList
...
export default defineComponent({
  ...
  setup() {
    ...
    /** Inject **/
    const { processingCommissionCosplay, initCommissionProcessing, closeProcessing } = inject(
      IndexKey
    ) as IndexStore
    /** /Inject **/
    ...
    initCommissionProcessing('cosplay')
    /** /Created **/
    ...
    meta.value = [
      ...
      { hid: 'og:title', property: 'og:title', content: 'コミッション一覧（コスプレ） | Pixage' },
      {
        hid: 'og:description',
        property: 'og:description',
        content: '',
      },
      { hid: 'og:url', property: 'og:url', content: 'https://pixage.app/commissions-cosplay' },
